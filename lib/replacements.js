...
const replacements = {
  ...
  'f': {
    ...
    parameters: {
      description: 'upper, lower, camel, pascal, or none for unmodified: {{f|modifier}}',
      default: ''
    },
    unique: true,
    function: function(fileObj, args) {
  ...
  'p': {
    ...
    parameters: {
      description: 'upper, lower, camel, pascal, or none for unmodified: {{p|modifier}}',
      default: ''
    },
    unique: false,
    function: function(fileObj, args) {
  ...
  'd': {
    ...
    depreciated: true,
    depreciationMessage: 'please use {{date|current}} instead',
    parameters: {
  ...
  'cd': {
    ...
    depreciated: true,
    depreciationMessage: 'please use {{date|create}} instead',
    parameters: {
  ...
  'md': {
    ...
    depreciated: true,
    depreciationMessage: 'please use {{date|modify}} instead',
    parameters: {
  ...
  'ad': {
    ...
    depreciated: true,
    depreciationMessage: 'please use {{date|access}} instead',
    parameters: {
